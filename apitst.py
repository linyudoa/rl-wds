...
for scene_id in range(args.idscenes_start, args.idscenes_end):
    ...
    env.wds.ep.ENsetlinkvalue(index = "XJ-P2", paramcode = "EN_INITSETTING", value = env.wds.pumps.speed[0])
    env.wds.ep.ENgetlinkvalue(index = "XJ-P2", paramcode = "EN_INITSETTING")
